// Система прогресса и уровней для десятичных дробей

class DecimalProgressTracker {
    constructor() {
        this.loadProgress();
    }
    ...
    loadProgress() {
        const saved = localStorage.getItem('mathTrainerDecimalProgress');
        if (saved) {
    ...
    saveProgress() {
        localStorage.setItem('mathTrainerDecimalProgress', JSON.stringify({
            level: this.level,
